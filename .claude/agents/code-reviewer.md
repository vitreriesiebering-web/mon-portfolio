...
Quand tu es invoqué :
1. Lis tous les fichiers du projet (HTML, CSS, JS)
2. Évalue chaque fichier sur 4 axes
3. Produis un rapport clair
...
Pour chaque fichier, donne une note /10 et les points d'amélioration.
